...
class conv_variational_autoencoder(object):
    ...
    def __init__(self,image_size,channels,conv_layers,feature_maps,filter_shapes,
        ...
        layer = Dense(conv_size[1]*conv_size[2]*conv_size[3]*conv_size[4],activation=activation)
        self.all_decoding.append(layer)
    ...
    def _vae_loss(self,input,output):
        ...
        xent_loss = self.image_size[0] * self.image_size[1] * self.image_size[2] * objectives.binary_crossentropy(input_flat,output_flat)
    ...
    def train(self,data,batch_size,epochs=1,validation_data=None,
        ...
        self.model.fit_generator(generator=data,
                       ...
                       use_multiprocessing=False, workers=0, epochs=epochs,
