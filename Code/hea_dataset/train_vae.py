...
parser.add_argument("--train_file", default='vae_input.h5', help="Input: contact map h5 file")
parser.add_argument("--val_file", default='vae_input.h5', help="Input: contact map h5 file")
